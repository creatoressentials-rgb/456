...
title: "What Is YouTube RPM? Formula, Meaning & Benchmarks"
description: "YouTube RPM is your true earnings per 1,000 views, after YouTube's cut, across ads, memberships, Premium & Super Chat. See the formula and honest benchmarks."
permalink: /glossary/youtube-rpm/
related_terms:
  - playback-based-cpm
  - monetized-playbacks
  - ad-revenue
...
<p>Example: $500 in estimated revenue from 200,000 views gives you an RPM of $2.50 — you're earning $2.50 for every 1,000 views, blended across all your monetization sources.</p>
<p>For Shorts, the calculation swaps in <a href="/glossary/engaged-views/">engaged views</a> instead of raw view count, since that's the metric Shorts monetization is actually built on.</p>

<h3>What counts toward RPM</h3>
<p>Per YouTube's own documentation, RPM combines:</p>
<ul>
...
<li><strong>Non-ad revenue.</strong> Memberships, Super Chat, and Super Thanks all raise RPM independent of your ad performance. A smaller, more loyal audience — <a href="/glossary/returning-viewers/">returning viewers</a> and <a href="/glossary/regular-viewers/">regular viewers</a> — converts to memberships at a meaningfully higher rate than a one-off, algorithm-driven audience, so RPM can rise even when raw view count doesn't.</li>
<li><strong>Content policy status.</strong> Limited or no ads (yellow-icon monetization limits) collapses RPM toward zero for the affected videos regardless of views.</li>
</ul>
...
<h3>FAQ</h3>
<h4>Is a higher RPM always better than more views?</h4>
