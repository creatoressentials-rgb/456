...
title: "Suggested Videos Meaning: YouTube Traffic Source Guide"
description: "Suggested Videos is the YouTube Analytics traffic source for views from the Up Next sidebar and autoplay. Learn what drives it and how to earn more."
permalink: /glossary/suggested-videos/
related_terms:
  - browse-features
  - recommended-videos
  - click-through-rate
...
<li><strong>Suggested Videos</strong> is anchored on the one video the viewer is watching <em>right now</em>. YouTube is effectively asking, "given that this person picked this video, what should they watch next?" That's a narrower, more immediate signal than Browse Features' broader history, which is why the tactics for earning each one look different.</li>
</ul>
<p>Browse Features rewards broad appeal to people not currently watching anything; Suggested Videos rewards being the obvious, specific next step after one particular video.</p>

<h3>What drives suggested placement</h3>
<p>Two mechanisms do most of the work:</p>
<ol>
...
<h3>FAQ</h3>
<h4>Do description link clicks count as Suggested Videos traffic?</h4>
<p>Yes. YouTube attributes clicks on links inside your video description to the Suggested videos source, not External — even though the click happens from a link you placed yourself.</p>
<h4>Why does my Suggested Videos traffic have a lower CTR than my Search traffic?</h4>
<p>Because it's reaching people mid-session on a broader, lower-intent basis rather than people who typed a specific query. As a video's Suggested reach widens, CTR typically drops even while total views climb — that's normal scaling, not underperformance.</p>
<h4>Is a high percentage of Suggested Videos traffic a good sign?</h4>
<p>It's a sign your channel is being actively recommended alongside other videos in your niche, which is generally healthy — but YouTube has never published an "ideal" traffic mix, so don't chase a specific percentage. Judge it against your own format and goals, not a benchmark from a blog.</p>
