...
**1. Trello** — Project management for channel planning. Organize video ideas, production tasks, and publishing schedules in one place. Much better than scattered notes.

**2. Google Calendar** — Block filming time, schedule publishing, coordinate meetings. Simple and free if you have a Google account.

**3. Clockify** — Free time tracker. Helps you understand where your hours actually go each week — often revealing that editing takes far longer than you think.

**4. Forest** — Gamified focus app. Stay off your phone during creative work sessions by growing a virtual tree. Oddly effective.
...
**7. SparkToro** — Reveals audience behavior: what they read, watch, follow, and search for. Freemium with meaningful free features.
...
**17. Google Keyword Planner** — Free keyword research through Google Ads. Identifies popular search terms, suggests related keywords, and shows search volume trends.
...
**21. ChatGPT** — Generate scripts, brainstorm video ideas, draft descriptions, and write comment responses at scale.

**22. Gemini** — Google's AI. Useful for research, outlining, and generating content ideas with access to current web data.

**23. Claude** — Strong at writing, editing, and structured thinking. Good for drafting scripts and analyzing content strategy.

**24. Perplexity** — AI-powered research tool. Crawls the web in real time to surface ideas, data, and content angles you might not find otherwise.
